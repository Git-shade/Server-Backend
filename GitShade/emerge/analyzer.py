...
import logging
import json
from GitShade.emerge.InitialNode import InitialNode, Position, Data
from GitShade.emerge.Edges import Edge
from typing import Any, List, Dict
from pathlib import Path
from GitShade.emerge.gitShade import gitShade
...
from GitShade.emerge.graph import GraphType, FileSystemNode, FileSystemNodeType
from GitShade.emerge.config import Configuration
from GitShade.emerge.analysis import Analysis
from GitShade.emerge.stats import Statistics
from GitShade.emerge.files import FileScanMapper
from GitShade.emerge.log import Logger
from GitShade.emerge.core import format_timedelta
...
class Analyzer:
    def __init__(self, config: Configuration, parsers):
        ...
        self._graphInitNodes: list = []
        self._graphEdges: list = []
    ...
    def start_scanning(self, analysis: Analysis):
        ...
        gitShadeObj: gitShade = gitShade(analysis.root_node)
        gitShadeObj.structurize_basicFormat(self._results)
        gitShadeObj.structurize_desiredFormat(analysis.root_node)
        gitShadeObj.calculate_dimensions()
